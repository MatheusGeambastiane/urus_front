...
import { dashboardTabRoutes, type DashboardTab } from "@/features/dashboard/data/dashboard-tabs";
...
const productUsageWatch = watchCreateService("productUsage") ?? [];
    ...
    const quickActions = [
      {
        ...
        image: "/marketing/relogio_urus.png",
      },
      {
      ...
      },
      {
        ...
        image: "/marketing/caixa_urus.png",
      },
    ];
        ...
        <section className="rounded-3xl border border-white/5 bg-[#0b0b0b] p-5">
          <div className="flex items-center gap-4">
            ...
            <div className="relative h-24 w-24 flex-shrink-0">
              <Image
                src="/marketing/relogio_urus.png"
                alt="Relógio Urus"
                fill
                sizes="96px"
                className="object-cover"
          ...
          <section className="rounded-3xl border border-white/5 bg-[#0b0b0b] p-1 shadow-card">
            ...
            >
              ...
              <div className="relative h-32 w-32 flex-shrink-0">
                <Image
                  src="/marketing/barbeiro_cortando.png"
  ...
  return (
    <>
      <div className="flex flex-col gap-5">{renderContentByTab()}</div>
