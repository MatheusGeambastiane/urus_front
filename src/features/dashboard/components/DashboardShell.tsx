...
import { BarChart3, Calendar, Home, Scissors, ShoppingBag, Users, Wallet } from "lucide-react";
...
const bottomNavItems: Array<{ key: DashboardTab; label: string; icon: ComponentType<{ className?: string; strokeWidth?: number }> }> = [
  ...
  { key: "performance", label: "Desempenho", icon: BarChart3 },
];
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white">
      ...
      <nav className="fixed bottom-4 left-1/2 w-full max-w-md -translate-x-1/2 px-4">
        <div className="grid grid-cols-7 gap-2 rounded-3xl border border-white/10 bg-[#0b0b0b]/80 p-2 backdrop-blur">
