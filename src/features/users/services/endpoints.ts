...
export const clientsEndpointBase = `${env.apiBaseUrl}/dashboard/users/clients/`;
export const professionalIntervalsEndpointBase = `${env.apiBaseUrl}/dashboard/professional-intervals/`;
